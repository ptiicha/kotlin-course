...
// FALSE — в Kotlin булевы значения записываются с маленькой буквы: true или false
...
val v19: Float = 5.75f
// `1.414` — это воспринимается как имя (идентификатор), а такой переменной нет
...
// “🤯” — используются типографские кавычки, а Kotlin требует обычные двойные кавычки
// val v32: String = “🤯”
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
// ‘65535’ — используются типографские кавычки; кроме того, для Char допустим только один символ
// val v34: Char = ‘65535’
...
// TRUE — в Kotlin булевы значения записываются с маленькой буквы: true или false
